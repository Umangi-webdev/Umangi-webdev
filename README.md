...
# Hi 👋, I'm Umangi Patel
### Full Stack Developer | AI -integrated Solution | Computer Engineering @ GEC Palanpur |9+ CGPA
...
I am a passionate **Full Stack Developer** specializing in **AI-integrated web solutions**. With a strong foundation in **Data Structures and Algorithms** (400+ problems solved on LeetCode), I focus on building scalable, real-time applications using modern frameworks and cloud technologies.

* 🎓 **B.E. in Computer Engineering** at Government Engineering College Palanpur (CGPA: 9.35+)
* 💼 **Former Web Development Intern** at NSIC, building AI-powered solutions with Azure
* 🏆 **Smart Gujarat Hackathon Finalist** & 2nd Prize winner in Coding Boot Camp
...
* Optimized frontend performance, reducing re-render frequency by **60%**.
